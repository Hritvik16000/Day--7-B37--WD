...
let movie1=new Movie("X-men","Marvel","Sony");
let movie2=new Movie("Spider man","Marvel","R");
let movie3=new Movie("Joker","DC","JP");
let movie4=new Movie("Aquaman","DC");
...
class Uber{
 ...
 let ride=new Uber();
  ride.getvalue("Lavasa","Pune",70,"XL");
  ride.price();
 let ride2=new Uber();
  ride2.getvalue("Mumbai","Lonavala",200);
  ride2.price();
